 # Scrape Twitter replies to a specific post #
def twitter_replies(tweetId):
  ...
  # use scraper
  for i,tweet in enumerate(sntwitter.TwitterTweetScraper(tweetId , mode=sntwitter.TwitterTweetScraperMode.SCROLL).get_items()):
    # if i >= n:
    #   break
    try:
